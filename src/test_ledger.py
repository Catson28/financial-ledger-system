...
class TestTransactions:
    ...
    def test_reverse_transaction(self, ledger_with_accounts):
        ...
        assert reversal_id != original_txn_id
...
class TestBalances:
    ...
    def test_account_balance_after_transaction(self, ledger_with_accounts):
        ...
        assert cash_balance == Decimal("1000.00")  # Asset increases with debit
        assert revenue_balance == Decimal("1000.00")  # Revenue increases with credit
